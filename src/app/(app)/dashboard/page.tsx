...
import { AlertTriangle, Database, Package, RadioTower, Rocket } from "lucide-react";
...
export default async function DashboardPage() {
  const [dashboard, analytics] = await Promise.all([getDashboardData(), getAnalyticsData()]);
